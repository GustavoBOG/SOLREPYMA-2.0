...
const BrandConcept = () => {
    const palette = [
        { name: 'Azul Carbón', hex: '#0D364E', type: 'PRIMARIO', bg: 'bg-[#0D364E]' },
        { name: 'Blanco', hex: '#FFFFFF', type: 'FONDO', bg: 'bg-[#FFFFFF]' },
        { name: 'Negro', hex: '#000000', type: 'CONTRASTE', bg: 'bg-[#000000]' },
        { name: 'Azul Acero', hex: '#3075B6', type: 'ACENTO', bg: 'bg-[#3075B6]' },
    ];

    return (
        <section id="concepto" className="bg-industrial-black py-24 px-8 md:px-24 border-b border-machine-metal">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="py-20 border-t border-white/5 mb-20">
                    <div className="grid md:grid-cols-12 gap-16 items-center">
                        {/* Image Left */}
                        <div className="md:col-span-5 bg-industrial-black/40 p-12 border border-white/5 rounded-2xl flex items-center justify-center">
                        ...
                        <div className="md:col-span-7 space-y-6">
                            ...
                            <div className="space-y-4 text-technical-text font-body text-lg leading-relaxed">
                                <p>
                ...
                <div className="pt-20 border-t border-white/5">
                    <div className="mb-12">
                        ...
                        <p className="text-technical-text text-lg font-body">
                            Estética funcional diseñada para legibilidad en condiciones extremas.
                        </p>
                    </div>

                    {/* TYPOGRAPHY CARD */}
                    <div className="bg-[#112233]/40 border border-white/5 rounded-2xl p-8 md:p-12 mb-12 shadow-2xl">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="space-y-12">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="text-technical-text font-body leading-relaxed max-w-md">
                                ...
                                {/* BODY TEXT SECTION */}
                                <div className="space-y-4">
                                    <span className="inline-block px-3 py-1 bg-white/5 text-technical-text text-[10px] font-bold rounded uppercase tracking-widest">
                                        Cuerpo de Texto
                                    </span>
                            ...
                            <div className="bg-[#09090b]/40 rounded-xl p-12 flex flex-col items-center justify-center border border-white/5 relative overflow-hidden aspect-video lg:aspect-square">
                                <div className="text-center relative z-10">
                                    ...
                                    <div className="text-5xl md:text-6xl font-display text-technical-text/40 mb-8 tracking-wider">Bb Cc</div>
                                    <div className="font-mono text-xs text-electric-blue/30 tracking-[1em]">0123456789</div>
                                </div>
                            ...
                            <div key={color.hex} className="bg-[#112233]/40 border border-white/5 p-5 rounded-2xl group hover:border-white/10 transition-all">
                                ...
                                <div className="flex justify-between items-end">
                                    <div>
                                        ...
                                        <p className="text-technical-text font-mono text-xs tracking-wider uppercase">{color.hex}</p>
                                    </div>
                                    <span className="text-[10px] font-mono font-bold text-technical-text/40 tracking-widest">
                                        {color.type}
                                    </span>
                                </div>
                            </div>
